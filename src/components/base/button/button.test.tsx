...
describe('Button', () => {
  describe('Rendering', () => {
    ...
    it('forwards ref correctly', () => {
      ...
      render(<Button ref={ref as React.RefObject<HTMLDivElement>}>Content</Button>);
  ...
  describe('Edge Cases', () => {
    ...
    it('handles null children gracefully', () => {
      render(<Button data-testid="component">{null}</Button>);
      expect(screen.getByTestId('component')).toBeInTheDocument();
    });

    it('handles undefined children gracefully', () => {
      render(<Button data-testid="component">{undefined}</Button>);
      expect(screen.getByTestId('component')).toBeInTheDocument();
    });
